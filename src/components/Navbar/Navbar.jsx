        ...
        >
          ...
          <div className="flex items-center md:space-x-4">
            ...
            <div className="flex items-center justify-end">
              <label className="swap swap-rotate">
                ...
                />
                <svg
                  className="swap-off h-5 w-5 text-text-muted hover:text-text-main fill-current"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                >
                ...
                <svg
                  className="swap-on h-5 w-5 text-text-main fill-current"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                >
            ...
            {user ? (
              <div className="dropdown dropdown-end z-50 group">
                ...
                <ul
                  tabIndex={0}
                  className="menu menu-sm dropdown-content mt-4 z-[1] p-0 shadow-2xl bg-bg-card rounded-2xl w-72 border border-card-border overflow-hidden transform transition-all duration-300 ease-in-out origin-top-right"
                >
              ...
              <div className="hidden lg:flex items-center gap-3">
                <Link
                  to="/login"
                  className="px-6 py-2.5 rounded-full font-bold text-text-main hover:bg-bg-body transition-all duration-300"
                >
                  Login
                </Link>
                <Link
          ...
          <div className="lg:hidden">
            <button
              ...
              className="text-text-main hover:text-accent-gold focus:outline-none"
