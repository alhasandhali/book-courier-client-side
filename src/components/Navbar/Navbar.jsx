...
const Navbar = () => {
    ...
    const mobileLinkClass = "block py-2 text-black border-b-2 border-transparent hover:border-accent-gold hover:text-accent-gold transition-all duration-300 ease-in-out";
                    ...
                    <div className="flex items-center md:space-x-4">
                        ...
                        <div className="group relative hidden sm:block">
                            ...
                            <div className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                                <svg className="h-4 w-4 text-gray-400 group-focus-within:text-accent-gold transition-colors duration-300" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="flex items-center justify-end">
                            <label className="swap swap-rotate">
                                <input
                                    ...
                                    checked={theme === 'dark'}
                                />
                                <svg className="swap-off h-5 w-5 text-gray-700 hover:text-black fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M5.64,17l-.71.71a1,1,0,0,0,0,1.41,1,1,0,0,0,1.41,0l.71-.71A1,1,0,0,0,5.64,17ZM5,12a1,1,0,0,0-1-1H3a1,1,0,0,0,0,2H4A1,1,0,0,0,5,12Zm7-7a1,1,0,0,0,1-1V3a1,1,0,0,0-2,0V4A1,1,0,0,0,12,5ZM5.64,7.05a1,1,0,0,0,.7.29,1,1,0,0,0,.71-.29,1,1,0,0,0,0-1.41l-.71-.71A1,1,0,0,0,4.93,6.34Zm12,.29a1,1,0,0,0,.7-.29l.71-.71a1,1,0,1,0-1.41-1.41L17,5.64a1,1,0,0,0,0,1.41A1,1,0,0,0,17.66,7.34ZM21,11H20a1,1,0,0,0,0,2h1a1,1,0,0,0,0-2Zm-9,8a1,1,0,0,0-1,1v1a1,1,0,0,0,2,0V20A1,1,0,0,0,12,19ZM18.36,17A1,1,0,0,0,17,18.36l.71.71a1,1,0,0,0,1.41,0,1,1,0,0,0,0-1.41ZM12,6.5A5.5,5.5,0,1,0,17.5,12,5.51,5.51,0,0,0,12,6.5Zm0,9A3.5,3.5,0,1,1,15.5,12,3.5,3.5,0,0,1,12,15.5Z" /></svg>
                                <svg className="swap-on h-5 w-5 text-gray-700 hover:text-black fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M21.64,13a1,1,0,0,0-1.05-.14,8.05,8.05,0,0,1-3.37.73A8.15,8.15,0,0,1,9.08,5.49a8.59,8.59,0,0,1,.25-2A1,1,0,0,0,8,2.36,10.14,10.14,0,1,0,22,14.05,1,1,0,0,0,21.64,13Z" /></svg>
                            </label>
                        </div>
                ...
                {mobileMenuOpen && (
                    <div className="lg:hidden mt-4 pb-4 border-t border-gray-200">
                        <ul className="flex flex-col space-y-2 mt-4">
                            ...
                            <li><NavLink to="/books" className={mobileLinkClass}>Books</NavLink></li>
                            <li><NavLink to="/about" className={mobileLinkClass}>About</NavLink></li>
                            <li><NavLink to="/contact" className={mobileLinkClass}>Contact</NavLink></li>
                            {user && <li><NavLink to="/dashboard" className={mobileLinkClass}>Dashboard</NavLink></li>}
                            {!user && (
                                <div className="flex flex-col gap-2 mt-2">
                                    <Link to="/login" className="block py-2 text-black hover:underline">Login</Link>
                                    <Link to="/register" className="block py-2 text-black hover:underline">Register</Link>
                                </div>
                            )}
                        </ul>
                    </div>
