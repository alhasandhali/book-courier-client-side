...
const Hero = () => {
  ...
  return (
    <section className="hero-section pt-12 pb-8">
      <div className="w-11/12 sm:w-10/12 mx-auto grid grid-cols-1 lg:grid-cols-2 items-center gap-5 md:gap-12 lg:gap-20">
        ...
        {/* Right Part */}
        <div className="hero-visuals relative w-full h-[350px] sm:h-[400px] md:h-[450px] flex items-center justify-center order-2">
          {books.length > 0 && (
            <Swiper
              effect="cards"
              grabCursor={true}
