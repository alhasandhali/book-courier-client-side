            ...
            <div className="category-slider py-4 sm:py-6 md:py-8">
                <div className="category-track flex gap-6 sm:gap-8 md:gap-12 animate-scroll">
                    ...
                    {categories.map((cat, index) => (
                        <div
                            key={`cat-1-${index}`}
                            className="cat-item flex items-center gap-2 sm:gap-3 text-[0.8rem] sm:text-[0.9rem] text-text-muted cursor-pointer hover:text-accent-gold transition-colors whitespace-nowrap flex-shrink-0"
                        >
