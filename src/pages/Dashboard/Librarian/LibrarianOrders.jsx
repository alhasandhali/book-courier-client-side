                            ...
                            >
                                ...
                                <td>
                                    <select
                                        ...
                                        className={`px-3 py-1 border border-card-border rounded-lg text-sm focus:ring-2 focus:ring-accent-gold outline-none ${order.status === 'cancelled' ? 'bg-bg-body opacity-50 cursor-not-allowed' : 'bg-bg-body text-text-main'
                                            }`}
                                    >
